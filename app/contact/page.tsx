  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="sticky top-0 left-0 right-0 h-14 flex items-center px-4 bg-gray-900/80 backdrop-blur-md border-b border-gray-800 z-10">
        ...
        <h1 className="flex-1 text-center text-lg font-semibold text-white">联系方式</h1>
      </div>

      <div className="p-4 pb-16">
        {/* 客服二维码 */}
        <Card className="p-4 bg-gray-900 border-gray-800 mb-4">
          <h2 className="text-lg font-semibold text-white mb-4 text-center">扫码添加客服</h2>
          ...
          <p className="text-sm text-gray-400 text-center">工作时间: {contactInfo.workingHours}</p>
        </Card>
        ...
        <Card className="p-4 bg-gray-900 border-gray-800 mb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-medium text-white">客服电话</h3>
        ...
        <Card className="p-4 bg-gray-900 border-gray-800 mb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-medium text-white">客服邮箱</h3>
        ...
        <Card className="p-4 bg-gray-900 border-gray-800">
          ...
          <div className="space-y-3">
            <div className="p-3 bg-gray-800 rounded-lg">
              <h3 className="font-medium text-white mb-1">如何购买课程？</h3>
              <p className="text-sm text-gray-300">
                您可以在"私教"页面浏览课程，选择心仪的课程后点击进入详情页，然后点击"立即购买"按钮完成支付。
              </p>
            </div>
            <div className="p-3 bg-gray-800 rounded-lg">
              <h3 className="font-medium text-white mb-1">如何使用AI助手？</h3>
              <p className="text-sm text-gray-300">
                在"AI助手"页面选择您需要的AI模型或助手，点击"开始对话"按钮即可开始使用。
              </p>
            </div>
            <div className="p-3 bg-gray-800 rounded-lg">
              <h3 className="font-medium text-white mb-1">如何参加考试？</h3>
              <p className="text-sm text-gray-300">
